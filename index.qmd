...
State-space models consist of 1. a transition (or state) equation that describes how the latent state evolves over time based on its previous state and observed inputs (daily surveys), and 2. an observation equation that describes the functional relationship between the unobserved, latent states and observed inputs.
