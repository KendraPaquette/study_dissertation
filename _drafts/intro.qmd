...
This dissertation proposal provides an initial line of research for developing an algorithm to be used in a recovery monitoring support system. Two projects (chapters 2 and 3) are completed and one project (chapter 4) is a proposed future direction. These projects are explained more below:
...
- **Chapter 3:**  Lagged predictions of next day alcohol use for personalized and adaptive continuing care support
    ...
    Another limitation was the computational expense of building several models to predict probabilities of lapse at varying times in the future. Better yet would be a single model that could look as far into the future as desired.
...
- **Chapter 4:** State-space models for idiographic risk monitoring and recovery support recommendations
    ...
    Finally, in this project we will be comparing traditional machine learning methods (used in chapters 2 and 3) with idiographic modeling methods. While traditional machine learning methods are good for modeling high dimensional feature sets intended to capture complex clinical phenomena. There are limitations in their ability to capitalize on the inherent repeated measures nature of the data. Bayesian state-space models may be one promising approach to idiographic prediction models. In this study, we will compare our best machine learning model with our best state-space model to evaluate performance, fairness, and usability of features as intervenable targets for recommendations.